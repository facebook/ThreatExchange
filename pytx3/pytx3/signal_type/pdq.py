...
class PdqSignal(signal_base.SimpleSignalType, signal_base.FileMatcher):
    ...
    def match_file(self, file: pathlib.Path) -> t.List[signal_base.SignalMatch]:
        ...
        try:
            from pytx3.hashing.pdq_hasher import pdq_from_file
        except:
            warnings.warn(
                "PDQ from file require Pillow and pdqhash to be installed; install pytx3 with the [pdq_hasher] extra to use them",
