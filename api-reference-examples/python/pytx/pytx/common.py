...
from .errors import pytxAttributeError, pytxValueError
...
class Common(object):
    ...
    _internal = ["_DETAILS", "_RELATED", "_changed", "_new", "_access_token", c.ID]
    ...
    def get_changed(self):
        ...
        return dict((n, getattr(self, n)) for n in self._changed if n != c.ID)
    ...
    def new(
        ...
        if cls.__name__ != "ThreatPrivacyGroup":
            if td.PRIVACY_TYPE not in params:
                ...
                if (
                    params[td.PRIVACY_TYPE] != pt.VISIBLE
    ...
    def expire(self, timestamp, retries=None, headers=None, proxies=None, verify=None):
        """
    ...
    def false_positive(
        self, object_id, retries=None, headers=None, proxies=None, verify=None
    ):
        """
    ...
    def react(self, reaction, retries=None, headers=None, proxies=None, verify=None):
        """
