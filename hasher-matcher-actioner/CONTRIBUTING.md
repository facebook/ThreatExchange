...
4. Use `[Cmd]+[Shift]+[P]` inside VS Code and choose "Remote-Containers: Open folder in container ..." and navigate to your checkout of facebook/ThreatExchange, and open  ./hasher-matcher-actioner/.devcontainer.
