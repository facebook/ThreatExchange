...
See [releasing.md](../website/content/hma/releasing.md) for the full release process, including how to update the [changelog](./CHANGELOG.md) and what happens automatically after merging.
